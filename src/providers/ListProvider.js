...
export const ListProvider = (props) =>{
    const data = [
        {titulo: 'Spider-Man', descricao: 'O Homem-Aranha precisa lidar com as consequências da sua verdadeira identidade ter sido descoberta.', horas: '1h 57m', categoria: 'acao', imgBanner : MiranhaBanner, imgMain:Miranha},
    ...
    const [filme, setFilme] = useState({titulo: 'Spider-Man', descricao: 'auhsuhaushaushuahsuahushuhsauhsuausihauis', horas: '1h 57m', categoria: 'acao', imgBanner : MiranhaBanner, imgMain:Miranha});
